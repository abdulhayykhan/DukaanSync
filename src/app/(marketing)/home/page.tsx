...
const fadeUp: Variants = {
  ...
  visible: (custom = 0) => ({
    opacity: 1,
    y: 0,
    transition: { ...easeOut, delay: custom * 0.1 },
  }),
};

// 3D reveal: cards tilt in from a rotated resting state as they enter view,
// rather than just fading/sliding — this is the "scroll animation" applied
// to Features + Pricing, not just the hero.
const tiltIn: Variants = {
  hidden: { opacity: 0, y: 40, rotateX: -20, scale: 0.94 },
  visible: (custom = 0) => ({
    opacity: 1,
    y: 0,
    rotateX: 0,
    scale: 1,
    transition: { ...easeOut, duration: 0.7, delay: custom * 0.08 },
  }),
};
...
// Fictional, generic — never real business data on a public marketing page.
const CHART_BARS = [38, 55, 45, 72, 60, 85, 68, 94];
...
export default function MarketingHomePage() {
  ...
  // Scroll-driven parallax / depth for the hero
  ...
  const scrollTranslateZ = useTransform(scrollYProgress, [0, 1], [50, 0]);

  // Cursor-tracked 3D tilt on the dashboard preview card, layered on top of
  // the scroll transform above — this is the actual "3D" the hero delivers:
  // the card visibly leans toward wherever the pointer is, with spring
  // easing so it settles rather than snapping.
  const pointerX = useMotionValue(0);
  const pointerY = useMotionValue(0);
  const pointerRotateX = useSpring(useTransform(pointerY, [-0.5, 0.5], [10, -10]), {
    stiffness: 150,
    damping: 20,
  });
  const pointerRotateY = useSpring(useTransform(pointerX, [-0.5, 0.5], [-10, 10]), {
    stiffness: 150,
    damping: 20,
  });

  function handleCardPointerMove(e: MouseEvent<HTMLDivElement>) {
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            >
              A multi-tenant retail management &amp; POS SaaS platform with strict
              data isolation. Track inventory, manage customer credit, and view
              financial reports across all your branches securely.
            </motion.p>
          ...
          >
            <motion.div
              ...
              className="relative rounded-2xl border border-gray-200/60 bg-white/50 backdrop-blur-sm shadow-2xl shadow-emerald-900/10 p-2 overflow-hidden ring-1 ring-black/5"
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-white/40 to-white/10 pointer-events-none z-10" />

              <div className="aspect-[16/9] w-full rounded-xl bg-gray-100 overflow-hidden border border-gray-200/50">
                <div className="w-full h-full bg-white flex flex-col">
                  ...
                  <div className="h-12 border-b border-gray-100 flex items-center px-4 gap-3 shrink-0">
                    ...
                    <div className="ml-auto w-7 h-7 rounded-full bg-emerald-100 flex items-center justify-center text-[10px] font-bold text-emerald-700">
                      AH
                    </div>
                  </div>
                  ...
                  <div className="flex flex-1 min-h-0">
                    {/* Sidebar */}
                    <div className="w-40 border-r border-gray-100 p-3 space-y-1 hidden sm:block">
                    ...
                    <div className="flex-1 p-5 space-y-4 overflow-hidden">
                      ...
                      <div className="h-28 rounded-xl border border-gray-100 bg-gray-50 p-3 flex items-end gap-1.5">
                        {CHART_BARS.map((h, i) => (
                          <div
                            key={i}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              DukaanSync brings enterprise-level multi-branch management to
      ...
      <section className="py-24 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              A streamlined onboarding process gets your business up and
              running immediately.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Choose the plan that fits your retail footprint. No hidden
              fees. Upgrade easily via EasyPaisa or JazzCash.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Join the platform built to help Pakistani retailers scale
...
function StatMini({
  ...
  return (
    <div className="rounded-xl border border-gray-100 bg-white shadow-sm p-3 flex flex-col gap-1.5">
...
function FeatureCard({
  ...
  return (
    <motion.div
      ...
      style={{ transformStyle: "preserve-3d" }}
      className="glass-card p-6 flex flex-col items-start text-left group hover:border-emerald-200 transition-colors"
    >
...
function StepCard({
  ...
  return (
    <motion.div
      variants={fadeUp}
      className="relative flex flex-col items-center text-center p-6 bg-white rounded-2xl border border-gray-100 shadow-sm z-10 hover:shadow-md transition-shadow"
    >
